...
PROMPTS = {
    "photo_2x2": (
        "You are validating a 2x2 PORTRAIT PHOTO uploaded for a training registration. "
        "Be PRAGMATIC: this is not for a passport — it just needs to be a recognizable headshot "
        "of the applicant. Approve any reasonable real portrait photo of a single person.\n\n"
        "ACCEPT (valid=true) if the image shows ONE real person's face clearly enough to identify them. "
        "The face should be the main subject and reasonably sharp. Casual clothing, indoor/outdoor "
        "backgrounds, smiling, accessories (glasses, hats, earrings), tilted heads, and varied lighting "
        "are all FINE. Aspect ratio doesn't have to be exactly square.\n\n"
        "You MUST NOT reject for any of these reasons:\n"
        "- Clothing style, color, formality, or attire (casual is fine, no need for business wear).\n"
        "- Hairstyle, makeup, jewelry, hats, glasses, or grooming.\n"
        "- Background color or pattern (as long as the face is clearly the focus).\n"
        "- Age, gender, ethnicity, expression, or smile vs. neutral face.\n"
        "- Slight tilt, slight blur, indoor lighting, or non-professional photography.\n"
        "- Aspect ratio if the face is centered and clearly visible.\n\n"
        "REJECT (valid=false) only if ANY of these are clearly true:\n"
        ...
        "(not a real photograph of a real human).\n"
        "- It is a full-body shot taken from far away where the face is tiny / not clearly visible.\n"
        "- It contains multiple people and you can't tell whose photo it is.\n"
        "- It is severely blurred, completely dark, or contains no recognisable face at all.\n"
        "- It is obviously not a photo of a person (an object, scenery, screenshot of text, etc.).\n\n"
        "Reply ONLY with strict JSON: "
        "{\"valid\": true|false, \"reason\": \"short user-facing explanation\", "
        "\"details\": {\"is_real_portrait\": bool, \"single_person\": bool, \"face_clearly_visible\": bool, "
